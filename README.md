...
Os cursos através de teoria, aplicação e projetos abordaram: HTML, JavaScript, CSS, React, Angular, Vue, Banco de dados relacional e não relacional, jQUERY, Bootstrap, API Rest, Gulp, Git, Webpack, Node, Express, Laravel, dentre outros.
